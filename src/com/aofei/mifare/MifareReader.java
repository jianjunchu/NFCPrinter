 ...
 *
 */
public class MifareReader implements IReader {
    ...
    {
        boolean found = false;
        if(readerType== com.aofei.nfc.NFCReaderUtil.READER_TYPE_SOCKET)
        {
            if(port== 0 )
...
//	    		}
    ...
    {
        com.aofei.nfc.NFCReaderUtil util = null;
        try {
            util = new com.aofei.nfc.NFCReaderUtil(com.aofei.nfc.NFCReaderUtil.READER_TYPE_SERIAL_PORT);
            util.setPort(0);
            util.init();
